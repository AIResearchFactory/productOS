...
- `Copilot will draft this first. You approve before anything is saved.`
...
| Copilot | Sparkles / WandSparkles | Ask Copilot | Help/action |
...
- Copilot actions say `draft`, `summarize`, `compare`, or `review` instead of vague AI verbs.
