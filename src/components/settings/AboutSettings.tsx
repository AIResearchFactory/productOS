        ...
        <div className="space-y-10 animate-in fade-in duration-500">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Card 
                    ...
                    onClick={() => handleOpenLink('https://github.com/assafmiron/product-os')}
                >
                ...
                <Card 
                    className="border border-gray-100 dark:border-gray-800 hover:border-primary/30 transition-all cursor-pointer group"
                    onClick={() => handleOpenLink('https://github.com/assafmiron/product-os/issues')}
                >
                    <CardContent className="p-4 flex items-center gap-4">
                        <div className="w-12 h-12 rounded-lg bg-gray-50 dark:bg-gray-900 flex items-center justify-center text-gray-600 dark:text-gray-400 group-hover:bg-primary/10 group-hover:text-primary transition-colors">
            ...
            <div className="pt-10 border-t border-gray-100 dark:border-gray-800 text-center space-y-6">
                <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-4 text-sm font-medium text-gray-500">
                    <button onClick={() => handleOpenLink('https://github.com/assafmiron/product-os/blob/main/LICENSE')} className="hover:text-primary transition-colors flex items-center gap-2">
                        <FileText className="w-4 h-4" /> License
                    </button>
                    <button onClick={() => handleOpenLink('https://github.com/assafmiron/product-os/blob/main/CREDITS.md')} className="hover:text-primary transition-colors flex items-center gap-2">
                        <Heart className="w-4 h-4" /> Credits
                    </button>
                    <button onClick={() => handleOpenLink('https://github.com/assafmiron/product-os/blob/main/PRIVACY.md')} className="hover:text-primary transition-colors flex items-center gap-2">
