            ...
            <section className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="flex flex-col gap-4">
                        <Button
                            ...
                            onClick={() => tauriApi.openUrl('https://github.com/AssafMiron/ai-researcher')}
                        >
                        ...
                        <Button
                            variant="outline"
                            className="flex-1 flex flex-col items-center justify-center gap-2 border-gray-200 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-900/50 group"
                            onClick={() => tauriApi.openUrl('https://github.com/AIResearchFactory/productOSissues')}
                        >
                ...
                <div className="text-center space-y-2 pt-4">
                    ...
                    <div className="flex items-center justify-center gap-4">
                        <button onClick={() => tauriApi.openUrl('https://github.com/AIResearchFactory/productOSblob/main/LICENSE')} className="text-2xs text-primary hover:underline focus:outline-none">License Info</button>
                        <span className="w-1 h-1 bg-gray-300 rounded-full"></span>
                        <button onClick={() => tauriApi.openUrl('https://github.com/AIResearchFactory/productOSblob/main/PRIVACY_POLICY.md')} className="text-2xs text-primary hover:underline focus:outline-none">Privacy Policy</button>
                        <span className="w-1 h-1 bg-gray-300 rounded-full"></span>
                        <button onClick={() => tauriApi.openUrl('https://github.com/AIResearchFactory/productOSblob/main/CREDITS.md')} className="text-2xs text-primary hover:underline focus:outline-none">Credits</button>
                    </div>
                </div>
            </section>
