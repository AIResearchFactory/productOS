...
|---------|---------|----------|--------|
| `@playwright/test` | 1.59.1 | Apache-2.0 | https://www.npmjs.com/package/@playwright/test |
...
| `@remotion/cli` | 4.0.384 | SEE LICENSE IN LICENSE.md | https://www.npmjs.com/package/@remotion/cli |
| `@tailwindcss/typography` | 0.5.19 | MIT | https://www.npmjs.com/package/@tailwindcss/typography |
| `@tiptap/extension-bubble-menu` | 3.22.4 | MIT | https://www.npmjs.com/package/@tiptap/extension-bubble-menu |
| `@tiptap/extension-floating-menu` | 3.22.4 | MIT | https://www.npmjs.com/package/@tiptap/extension-floating-menu |
| `@tiptap/extension-link` | 3.22.4 | MIT | https://www.npmjs.com/package/@tiptap/extension-link |
| `@tiptap/extension-placeholder` | 3.22.4 | MIT | https://www.npmjs.com/package/@tiptap/extension-placeholder |
| `@tiptap/extension-table` | 3.22.4 | MIT | https://www.npmjs.com/package/@tiptap/extension-table |
| `@tiptap/extension-table-cell` | 3.22.4 | MIT | https://www.npmjs.com/package/@tiptap/extension-table-cell |
| `@tiptap/extension-table-header` | 3.22.4 | MIT | https://www.npmjs.com/package/@tiptap/extension-table-header |
| `@tiptap/extension-table-row` | 3.22.4 | MIT | https://www.npmjs.com/package/@tiptap/extension-table-row |
| `@tiptap/markdown` | 3.22.4 | MIT | https://www.npmjs.com/package/@tiptap/markdown |
| `@tiptap/pm` | 3.22.4 | MIT | https://www.npmjs.com/package/@tiptap/pm |
| `@tiptap/react` | 3.22.4 | MIT | https://www.npmjs.com/package/@tiptap/react |
| `@tiptap/starter-kit` | 3.22.4 | MIT | https://www.npmjs.com/package/@tiptap/starter-kit |
| `@tiptap/suggestion` | 3.22.4 | MIT | https://www.npmjs.com/package/@tiptap/suggestion |
| `@types/node` | 25.5.0 | MIT | https://www.npmjs.com/package/@types/node |
| `@types/papaparse` | 5.5.2 | MIT | https://www.npmjs.com/package/@types/papaparse |
| `@types/react` | 18.3.12 | MIT | https://www.npmjs.com/package/@types/react |
| `@types/react-dom` | 18.3.1 | MIT | https://www.npmjs.com/package/@types/react-dom |
| `@types/tippy.js` | 6.3.0 | MIT | https://www.npmjs.com/package/@types/tippy.js |
| `@vitejs/plugin-react` | 6.0.1 | MIT | https://www.npmjs.com/package/@vitejs/plugin-react |
| `@xyflow/react` | 12.10.0 | MIT | https://www.npmjs.com/package/@xyflow/react |
| `autoprefixer` | 10.4.16 | MIT | https://www.npmjs.com/package/autoprefixer |
| `baseline-browser-mapping` | 2.9.13 | Apache-2.0 | https://www.npmjs.com/package/baseline-browser-mapping |
| `chokidar` | 5.0.0 | MIT | https://www.npmjs.com/package/chokidar |
| `class-variance-authority` | 0.7.1 | Apache-2.0 | https://www.npmjs.com/package/class-variance-authority |
| `clsx` | 2.1.1 | MIT | https://www.npmjs.com/package/clsx |
| `concurrently` | 9.2.1 | MIT | https://www.npmjs.com/package/concurrently |
...
| `react-ga4` | 3.0.1 | MIT | https://www.npmjs.com/package/react-ga4 |
...
| `remotion` | 4.0.384 | SEE LICENSE IN LICENSE.md | https://www.npmjs.com/package/remotion |
| `start-server-and-test` | 2.1.2 | MIT | https://www.npmjs.com/package/start-server-and-test |
| `tailwind-merge` | 3.4.0 | MIT | https://www.npmjs.com/package/tailwind-merge |
| `tailwindcss` | 3.3.5 | MIT | https://www.npmjs.com/package/tailwindcss |
...
| `url` | 0.11.4 | MIT | https://www.npmjs.com/package/url |
| `vite` | 8.0.9 | MIT | https://www.npmjs.com/package/vite |
| `vite-plugin-pwa` | 1.2.0 | MIT | https://www.npmjs.com/package/vite-plugin-pwa |
| `webdriverio` | 9.27.0 | MIT | https://www.npmjs.com/package/webdriverio |
