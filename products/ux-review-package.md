...
| Create New Project workspace | PM lead | New initiative starts | New Project -> name/goal -> optional skills/context -> start | Empty-state anxiety, unclear next best action | Guided starter checklist per project | % new projects with first artifact/workflow created |
